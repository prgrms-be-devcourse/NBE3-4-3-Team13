...
public class FileUploadController {
	...
	private final String bucketName = "bucket-get-started_linkus-453401"; // 구글 클라우드 스토리지 버킷 이름

	@GetMapping("/generate-signed-url")
	public ResponseEntity<String> generateSignedUrl(@RequestParam String filename) {
		// 스토리지에서 파일 찾기
	...
	private FileUploadController() throws IOException {
		// resources에서 서비스 계정 키 로드
		ClassPathResource resource = new ClassPathResource("linkus-453401.json");
